...
NWS_shapefile_path = os.path.join(save_path, 'current_all.shp')

# File path to the mapping shapefiles
state_shapefile_path = os.path.join(save_path, 'NYS Shorline.shp')
counties_path = os.path.join(save_path, 'NYS Counties.shp')
USstates_path = os.path.join(save_path, 'US StatesCoastlines.shp')
world_path = os.path.join(save_path, 'Worlds-32116.shp')
...
#######################################################
    ...
    # Save the plot
    output_map_path = os.path.join(current_dir, f'Current_NY_{name}_Alert.png')
